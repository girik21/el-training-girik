...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { task_details: @table.task_details, task_name: @table.task_name } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { task_details: @table.task_details, task_name: @table.task_name } }
